...
final puzzleData = Puzzle(
  connections: {
    ...
    'VOETBAL': ['Stadion', 'Buitenspel', 'Corner', 'Penalty'],
    'FRUIT': ['Appel', 'Banaan', 'Sinaasappel', 'Peer'],
    'FILM': ['Regisseur', 'Acteur', 'Scenario', 'Camera'],
    'MUZIEK': ['Gitaar', 'Piano', 'Drums', 'Zang'],
    'EUROPA': ['Nederland', 'Duitsland', 'Frankrijk', 'Spanje'],
    'PLANETEN': ['Mercurius', 'Venus', 'Aarde', 'Mars'],
    'KLEUREN': ['Rood', 'Blauw', 'Geel', 'Groen'],
    'MEUBELS': ['Stoel', 'Tafel', 'Kast', 'Bank'],
  },
);
